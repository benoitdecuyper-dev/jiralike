...
- Recherche texte (titre + description) + filtres combinables (statut / priorité / type).
- Import en masse de tickets depuis une liste Markdown (« prêt à coller »).
...
npm test           # tests unitaires Vitest (helpers purs : src/**/*.test.js)
```
Intégration continue : `.github/workflows/ci.yml` (lint + tests + build) à la racine du dépôt — s'active une fois le repo poussé sur GitHub.
